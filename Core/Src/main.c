...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOA,
                    Motor_BIN2_Pin | Motor_BIN1_Pin | Motor_STBY_Pin |
                        Motor_AIN2_Pin | Motor_AIN1_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_SET);

  /*Configure GPIO pins : Motor_BIN2_Pin Motor_BIN1_Pin Motor_STBY_Pin
     Motor_AIN2_Pin Motor_AIN1_Pin */
  GPIO_InitStruct.Pin = Motor_BIN2_Pin | Motor_BIN1_Pin | Motor_STBY_Pin |
                        Motor_AIN2_Pin | Motor_AIN1_Pin;
